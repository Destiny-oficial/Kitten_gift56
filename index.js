...
👋 ¡Hola! soy ${botname}! tu bot neko de confianza
 !en que te puedo ayudar y feliz año nuevo gracias por venir a este grupo a pasar este año nuevo con nosotros 😁 te quiero mucho esperemos estar mas años contigo🤗! 
 
 ◦•●◉✿ 𝐵𝑜𝑡 kitten 𝑂𝑓𝑖𝑐𝑖𝑎𝑙 ✿◉●•◦
 
 @${participant.split('@')[0]} 
Bienvenido(a) al grupo *${(await sock.groupMetadata(id)).subject}*.
Feliz año nuevo miembro. 🎉 
 ...
 *${(await sock.groupMetadata(id)).subject}*.
 ...
 espero te vaya bien fuera del grupo xd
 Neko bot de Destiny Oficial🌸
 
> ¡Te Deseamos un feliz año nuevo fuera del grupo, espero te la pases de lo mejor
...
warn @user razón
para dar una advertencia en un grupo.

warns @user
para ver las advertencia de un usuario.
